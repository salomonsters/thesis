    ...
    for S_h_in_nm, S_v, t_l_in_minutes, as_events in itertools.product(*[[3, 6], [1000, 2000], [5, 10], [False, True]]):
        ...
        for ext in ['png', 'eps']:
            for overleaf_project_name in ['thesis_full', 'thesis_article']:
                ...
                filename = 'figures/replay/{}_2018010[1-2-4-5]-S_h-{}-S_v-{}-t_l-{:.4f}{}.{}'.format(filename_prefix, S_h_in_nm, S_v, t_l, timeshift_suffix, ext)
        ...
        figure_filename = '{}_2018010[1-2-4-5]-S_h-{}-S_v-{}-t_l-{:.4f}{}.{}'.format(filename_prefix, S_h_in_nm, S_v, t_l, timeshift_suffix, 'png')
        scenario_string = "Day-by-day, $S_h$={}, $S_v$={}, $t_l$={}{}".format(S_h_in_nm, S_v, t_l_in_minutes,
                                                                               title_suffix)
